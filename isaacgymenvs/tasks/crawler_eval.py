...
from isaacgym.torch_utils import quat_rotate_inverse, normalize, to_torch
...
class CrawlerEval(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        if self.vertical:
            orients = [gymapi.Quat.from_euler_zyx(-np.pi/2, heading, 0) for heading in self.headings]
            ...
            orients = [gymapi.Quat.from_euler_zyx(0.0, 0.0, heading) for heading in self.headings]
