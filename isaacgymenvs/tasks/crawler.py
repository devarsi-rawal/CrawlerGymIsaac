...
class Crawler(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        num_bodies = self.gym.get_asset_rigid_body_count(crawler_asset)
        ...
        for i in range(self.num_envs):
            ...
            dof_props['damping'][self.wheel_dof] = 0.1 
    ...
    def post_physics_step(self):
        ...
        # print("Progress: ", self.progress_buf[0].item())
...
def compute_crawler_reward(measured_lin_vel, measured_ang_vel, target_lin_vel, target_ang_vel):
    ...
    # TODO: Add tracking sigmas to cfg task file
    # reward = lin_vel_error # + torch.exp(-ang_vel_error/0.75)
